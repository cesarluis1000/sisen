	...
	<table class="table table-bordered table-hover table-condensed">
    	<thead>
        	<tr>
        			...
        			<th><?php echo $this->Paginator->sort('variable'); ?></th>
    	...
    	<tbody>
        	...
        	<tr>
        		...
        		<td><?php echo h($parametro['Parametro']['modulo']); ?>&nbsp;</td>
        		<td><?php echo h($parametro['Parametro']['variable']); ?>&nbsp;</td>
        		...
        		<td class="actions">
        			...
        			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $parametro['Parametro']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $parametro['Parametro']['id']))); ?>
        		</td>
        	</tr>
        	<?php endforeach; ?>
    	</tbody>
