...
<div class="row">
	<div class="col-md-10">
			<?php echo $this->Form->create('User', array('type' => 'get','url' => 'index','class' => 'form-inline','inputDefaults'=>array('div' => array('class' => 'form-group'),'class'=>'form-control input-xs'))); ?>	
...
<table class="table table-hover table-condensed">
	...
	<tr>
		...
		<td><?php echo h($a_estados[$user['User']['estado']]); ?>&nbsp;</td>
		<td><?php echo h($user['User']['creador']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['creado']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['modificador']); ?>&nbsp;</td>
		<td><?php echo h($user['User']['modificado']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Html->link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-edit')), array('action' => 'edit', $user['User']['id']),array('class' => 'btn btn-warning btn-xs','escape'=>false)); ?>
			<?php echo $this->Form->postLink($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-trash')), array('action' => 'delete', $user['User']['id']),array('class' => 'btn btn-danger btn-xs','escape'=>false), __('Are you sure you want to delete # %s?', $user['User']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
