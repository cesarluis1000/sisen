<fieldset>
	<legend><?php echo __('Agregar Menu'); ?></legend>
...
<?php
	...
	echo $this->Form->input('nombre',array('label'=>array('class'=>'control-label col-sm-2'),'required'=>'required'));
	echo $this->Form->input('aco_id',array('label'=>array('class'=>'control-label col-sm-2'),'options'=> $a_aplicaciones,'empty' => 'Seleccionar'));
?>
<div class="form-group">
