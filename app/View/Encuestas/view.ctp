	...
	<tr>
		...
		<td class="actions">
			<div <?php echo ($encuesta['Encuesta']['estado'] == 'A')?"":"class='hide'";?> >
    			...
    			<?php echo (in_array($encuestado['Encuestado']['estado'],array('E','L')))?$this->Html->link($this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-eye-open')), array('controller' => 'Encuestados', 'action' => 'view', $encuestado['Encuestado']['id']),array('class' => 'btn btn-info btn-xs','escape'=>false)):''; ?>
