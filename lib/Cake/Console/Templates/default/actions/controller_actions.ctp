 ...
 */
	public function <?php echo $admin ?>index() {
		...
		$campo = !empty($this-><?php echo $currentModelName ?>->displayField)?$this-><?php echo $currentModelName ?>->displayField:'id';
		$this->set('campo',$campo);
		if (!empty($this->request->query[$campo])){	    
		    $nombre = $this->request->query[$campo];
			$this->request->data['<?php echo $currentModelName; ?>'][$campo] = $nombre ;
			$conditions = array('conditions' => array('<?php echo $currentModelName; ?>.'.$campo.' LIKE' => '%'.$nombre.'%'));
